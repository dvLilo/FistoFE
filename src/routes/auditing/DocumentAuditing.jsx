...
import DocumentAuditingActions from './DocumentAuditingActions'
import DocumentAuditingTransaction from './DocumentAuditingTransaction'

const DocumentAuditing = () => {
  ...
  const [state, setState] = React.useState("pending-audit")
