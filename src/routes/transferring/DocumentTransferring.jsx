...
import DocumentTransferringActions from './DocumentTransferringActions'
import DocumentTransmittingTransaction from './DocumentTransferringTransaction'

const DocumentTransferring = () => {
        ...
        <Stack className="FstoStackToolbar-root" justifyContent="space-between" gap={2}>
          ...
          <Stack className="FstoStackToolbar-item" direction="column" justifyContent="center" gap={1}>
            ...
            >
              ...
              <Tab className="FstoTab-root" label="Received" value="gas-receive" disableRipple />
              <Tab className="FstoTab-root" label="Transmitted" value="gas-gas" disableRipple />
              <Tab className="FstoTab-root" label="Held" value="gas-hold" disableRipple />
              <Tab className="FstoTab-root" label="Returned" value="gas-return" disableRipple />
            </Tabs>
...
export default DocumentTransferring