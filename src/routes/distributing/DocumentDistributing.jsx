...
import DocumentDistributingActions from './DocumentDistributingActions'
import DocumentDistributingTransaction from './DocumentDistributingTransaction'

const DocumentDistributing = () => {
  ...
  const [state, setState] = React.useState("pending-discharge")
      ...
      <Paper className="FstoPaperTable-root" elevation={1}>
        <Stack className="FstoStackToolbar-root" justifyContent="space-between" gap={2}>
          ...
          <Stack className="FstoStackToolbar-item" direction="column" justifyContent="center" gap={1}>
            ...
            >
              <Tab className="FstoTab-root" label="Pending" value="pending-discharge" disableRipple />
              <Tab className="FstoTab-root" label="Received" value="discharge-receive" disableRipple />
              <Tab className="FstoTab-root" label="Transmitted" value="discharge-discharge" disableRipple />
            </Tabs>
          ...
          <Table className="FstoTable-root" size="small">
            <TableHead className="FstoTableHead-root">
              <TableRow className="FstoTableRow-root">
                {
                  state === 'pending-discharge' && status === 'success' &&
        ...
        <DocumentDistributingTransaction
          {...manage}
          state={state}
...
export default DocumentDistributing