...
const DocumentConfidentialApprovingActions = (props) => {
  ...
  return (
    <React.Fragment>
      ...
      >
        ...
        {
          (state === `approve-approve` || state === `approve-hold` || state === `approve-return`) &&
          <MenuItem
            sx={{ fontWeight: 500 }}
            onClick={() => {
              onView(data)
...
export default DocumentConfidentialApprovingActions