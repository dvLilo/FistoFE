...
import DocumentConfidentialVoucheringActions from './DocumentConfidentialVoucheringActions'
import DocumentConfidentialVoucheringTransaction from './DocumentConfidentialVoucheringTransaction'

const DocumentConfidentialVouchering = () => {
    ...
    data: [
      {
        ...
        ...(Boolean(state.match(/-voucher.*/)) && { status: "voucher" }),
        ...(Boolean(state.match(/-hold.*/)) && { status: "hold" }),
        ...(Boolean(state.match(/-return.*/)) && { status: "return" }),
        ...(Boolean(state.match(/-void.*/)) && { status: "void" }),
        users: {
          id: 2,
      ...
      <Paper className="FstoPaperTable-root" elevation={1}>
        <Box className="FstoBoxToolbar2-root">
          <Box className="FstoBoxToolbar-left">
            <Typography variant="heading">Tagging and Vouchering</Typography>
          </Box>
...

              {
                ...
                && data.data.map((item, index) => (
                  <TableRow className="FstoTableRow-root" key={index} hover>
                    ...
                    <TableCell className="FstoTableCell-root FstoTableCell-body" align="center">
                      <DocumentConfidentialVoucheringActions
                        data={item}
                        state={state}
                        onReceive={onReceive}
                        onCancel={onUnreturn}
        ...
        <DocumentConfidentialVoucheringTransaction
          {...manage}
          state={state}
...
export default DocumentConfidentialVouchering