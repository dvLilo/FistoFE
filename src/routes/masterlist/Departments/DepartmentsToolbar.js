...
const DepartmentsToolbar = (props) => {
      ...
      if (types.includes(file.type)) {
        ...
        reader.onload = async (r) => {
          ...
          if (Boolean(data.length)) {
            ...
            let response
            try {
              response = await axios.post(`/api/admin/departments/import`, data)
              ...
              if (status === 409) {
                ...
                toast({
                  show: true,
                  title: "Error",
                  message: "Something went wrong whilst importing departments masterlist.",
                  severity: "error"
                })
              }
            }
  ...
  return (
    <React.Fragment>
      <Box className="FstoBoxToolbar-left">
        <Typography variant="heading">Departments</Typography>
