...
import UtilityCategoriesForm from './UtilityCategoriesForm'
import UtilityCategoriesTable from './UtilityCategoriesTable'
import UtilityCategoriesToolbar from './UtilityCategoriesToolbar'
...
const UtilityCategories = () => {
  ...
  const {
    ...
    pageChange,
    rowChange
  } = useFistoHook("/api/admin/utility-category")
  ...
  const dataStatusHandler = (data) => {
    ...
    setConfirm({
      ...
      onConfirm: async () => {
        ...
        let response
        try {
          response = await axios.patch(`/api/admin/utility-category/${id}`, {
