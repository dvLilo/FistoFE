...
import PayrollCategoriesForm from './PayrollCategoriesForm'
import PayrollCategoriesToolbar from './PayrollCategoriesToolbar'
import PayrollCategoriesTable from './PayrollCategoriesTable'
...
const PayrollCategories = () => {
  ...
  const {
    ...
    pageChange,
    rowChange
  } = useFistoHook("/api/admin/payroll-category")
  ...
  const dataStatusHandler = (data) => {
    ...
    setConfirm({
      ...
      onConfirm: async () => {
        ...
        let response
        try {
          response = await axios.patch(`/api/admin/payroll-category/${id}`, {
