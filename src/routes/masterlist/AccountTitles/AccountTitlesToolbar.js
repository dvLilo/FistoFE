...
const AccountTitlesToolbar = (props) => {
      ...
      if (types.includes(file.type)) {
        ...
        reader.onload = async (r) => {
          ...
          if (Boolean(data.length)) {
            ...
            let response
            try {
              response = await axios.post(`/api/admin/account-title/import`, data)
              ...
              if (status === 409) {
                ...
                toast({
                  show: true,
                  title: "Error",
                  message: "Something went wrong whilst importing account titles masterlist.",
                  severity: "error"
                })
              }
            }
...
export default AccountTitlesToolbar