      ...
      if (types.includes(file.type)) {
        ...
        reader.onload = async (r) => {
          ...
          if (Boolean(data.length)) {
            ...
            let response
            try {
              response = await axios.post(`/api/admin/locations/import`, data)
              ...
              if (status === 409) {
                ...
                toast({
                  show: true,
                  title: "Error",
                  message: "Something went wrong whilst importing locations masterlist.",
                  severity: "error"
                })
              }
            }
  ...
  return (
    <React.Fragment>
      <Box className="FstoBoxToolbar-left">
        <Typography variant="heading">Locations</Typography>
