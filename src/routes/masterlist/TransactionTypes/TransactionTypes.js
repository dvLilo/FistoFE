...
import TransactionTypesForm from './TransactionTypesForm'
import TransactionTypesToolbar from './TransactionTypesToolbar'
...
const TransactionTypes = () => {
  ...
  const {
    ...
    pageChange,
    rowChange
  } = useFistoHook("/api/admin/transaction-types")
  ...
  const dataStatusHandler = (data) => {
    ...
    setConfirm({
      ...
      onConfirm: async () => {
        ...
        let response
        try {
          response = await axios.patch(`/api/admin/transaction-types/${id}`, {
